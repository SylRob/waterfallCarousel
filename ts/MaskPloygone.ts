...
class MaskPloygone {
    ...
    draw( points:Array<any> ) {
        ...
        this.ctx.drawImage(this.img, imgPoints.cx, imgPoints.cy, imgPoints.cw, imgPoints.ch,  imgPoints.x, imgPoints.y, Math.abs(imgPoints.x2 - imgPoints.x), Math.abs(imgPoints.y2 - imgPoints.y) );
        ...
        for( var i = 0; i < this.shapePoints.length; i++ ) {
            ...
            if( points.type == 'bezier' ) {
                ...
                for( var j = 0; j < bezierDist; j++ ) {
                    ...
                    /*var startPoint =  this.bezierPoints( points.x, points.y, points.cp1x, points.cp1y, points.cp2x, points.cp2y, points.x2, points.y2, pour );*/
                    var bezier = new Bezier( points.x,points.y , points.cp1x,points.cp1y , points.cp2x,points.cp2y, points.x2,points.y2 );
                    var startPoint = bezier.get(pour);
    ...
    **/
    private bezierPoints( p0x, p0y, cp0x, cp0y, cp1x, cp1y, p1x, p1y,  t ):any {
